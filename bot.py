...
def cancel(update, context):
    user_id = update.message.from_user.id
    context.bot.send_message(chat_id=user_id, text="DONASI UNTUK KAMI.\nGopay : 087832060706 \n\nTerimakasih yang sudah donasi,hasil donasi akan kami gunakan untuk kebutuhan layanan ini bukan untuk pribadi \n", reply_markup=ReplyKeyboardRemove())
